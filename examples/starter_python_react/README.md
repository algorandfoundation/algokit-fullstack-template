...
3. Open the project and start debugging / developing on:
   - [starter_python_react-contracts](projects/starter_python_react-contracts/README.md) - Refer to the README for more information on how to work with smart contracts.
   - [starter_python_react-frontend](projects/starter_python_react-frontend/README.md) - Refer to the README for more information on how to work with the frontend application.
